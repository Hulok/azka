...
<body>
    <div id="header">
        <div class="container-atas">
            <nav>
              <div class="header-1">
                <img src="wikrama-logo.png" class="logo_1">
...
<body>
  ...
  <br><br><br>
    ...
    <div class="header-text-1">
        ...
        <div class="card1">
    <img src="hati.jpg" alt="Logo" class="logo1">
  ...
  <div class="card1">
    <img src="ceklis2.jpg" alt="Logo" class="logo1">
  ...
  <div class="card1">
    <img src="ceklis.jpg" alt="Logo" class="logo1">
    ...
    <?php $i = 1; ?>
        ...
        <div class="galeri"></div> 
            <div class="gallery">
              ...
              <img src="gambar0.jpg" alt="Above Photo 1">
              <img src="masjid1.jpg" alt="Above Photo 2">
              <img src="masjid4.jpg" alt="Above Photo 3">
            </div>

            <div class="gallery">
              
              <img src="masjid2.jpg" alt="Below Photo 1">
              <img src="masjid3.jpg" alt="Below Photo 2">
              <a href="galeri.php"><img src="beranda.jpg" alt="Below Photo 3"></a>
            </div>
          <br><br><br>
